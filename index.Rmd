...
## but even when $W$, $S$, $C$, and $R$ are *completely* known
...
## Yet big data (-omics) approaches to other questions in biomedicine largely overlook *behavior*
...
- "Responses" include changes in (or maintenance of) body configurations 
- AND autonomic/endocrine activity AND...
